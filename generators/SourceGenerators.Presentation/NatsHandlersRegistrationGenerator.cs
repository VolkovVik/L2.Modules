...
public sealed class NatsHandlersRegistrationGenerator : BaseRegistrationGenerator, IIncrementalGenerator
{
    ...
    private static readonly string Namespace = typeof(NatsHandlersRegistrationGenerator).Namespace;
    ...
    private static string GenerateString(Compilation compilation, ImmutableArray<INamedTypeSymbol?> classSymbols)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("internal static class NatsHandlersRegistration");
        sb.AppendLine("{");
