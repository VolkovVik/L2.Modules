...
public sealed class ValidatorRegistrationGenerator : IIncrementalGenerator
{
    ...
    private static void Generate(SourceProductionContext context, (Compilation compilation, ImmutableArray<INamedTypeSymbol?> classes) data)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("public static class ValidatorRegistrationGenerator");
        sb.AppendLine("{");
        ...
        sb.AppendLine("    }");
        sb.AppendLine("}");
        context.AddSource("ValidatorRegistrationGenerator.g.cs", SourceText.From(sb.ToString(), Encoding.UTF8));
    }
