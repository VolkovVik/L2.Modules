...
#pragma warning restore MA0051 // Method is too long
    {
        ...
        sb.Append("public partial class ")
          ...
          .Append("    public static IEnumerable<")
          .Append(className)
          .AppendLine("> GetList() =>")
          .Append("        [");
        ...
        sb.AppendLine(" ];")
          ...
          .AppendLine("    /// <returns></returns>")
          .Append("    public static Aspu.Common.Domain.Results.Result<")
          .Append(className)
          .AppendLine(", Error> GetByName(string name)")
          .AppendLine("    {")
